import {
  ...
  Vn,
  zn
} from "./chunk-B27JGOGP.js";
import {
  GenIcon
} from "./chunk-TNTFYMY2.js";
import "./chunk-KWIZEKLD.js";
import {
  B,
  FloatingDelayGroup,
  R,
...
import {
  ...
  Re,
  rn
} from "./chunk-VEWEF43G.js";
import "./chunk-5NNLBS7K.js";
import {
  require_jsx_runtime
...
var findChangeRange = memoizeOnce(function(prevValue, newValue) {
  ...
  while (prevValue[prevLength - 1 - j3] === newValue[newLength - 1 - j3] && newLength - j3 > i && prevLength - j3 > i) {
    j3++;
  }
  return {
    from: { start: i, end: prevLength - j3 },
    to: { start: i, end: newLength - j3 }
  };
});
...
function getCaretPosition(newFormattedValue, lastFormattedValue, curValue, curCaretPos, boundary, isValidInputCharacter, isCharacterSame) {
  ...
  for (var i = 0; i < curValLn; i++) {
    indexMap[i] = -1;
    for (var j3 = 0, jLn = formattedValueLn; j3 < jLn; j3++) {
      var isCharSame = isCharacterSame({
        currentValue: curValue,
        lastValue: lastFormattedValue,
        formattedValue: newFormattedValue,
        currentValueIndex: i,
        formattedValueIndex: j3
      });
      if (isCharSame && addedIndexMap[j3] !== true) {
        indexMap[i] = j3;
        addedIndexMap[j3] = true;
        break;
      }
    }
  }
...
var H = (e, t, n = false) => {
  ...
  function i(e2, r3 = "--bn") {
    for (let a in e2) {
      let o = `${r3}-${a.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()}`;
...
var W = (e) => H(fe, e, true);
var G2 = (e) => (0, import_jsx_runtime344.jsxs)(Stack, {
  gap: 0,
  className: "bn-tooltip",
  children: [(0, import_jsx_runtime344.jsx)(Text, {
    size: "sm",
    lineClamp: 5,
    children: e.mainTooltip
  }), e.secondaryTooltip && (0, import_jsx_runtime344.jsx)(Text, {
    size: "xs",
    lineClamp: 5,
    children: e.secondaryTooltip
  })]
});
var K = (0, import_react441.forwardRef)((e, t) => {
  ...
  Re(m, false);
  let [g, _] = (0, import_react441.useState)(false), y = a ? (0, import_jsx_runtime344.jsx)(Button, {
    "aria-label": f,
    className: i,
    onMouseDown: (e2) => {
    ...
    ...m,
    children: a
  }) : (0, import_jsx_runtime344.jsx)(ActionIcon, {
    className: i,
    "aria-label": f,
    onMouseDown: (e2) => {
      Be() && e2.currentTarget.focus();
  ...
  return o ? (0, import_jsx_runtime344.jsx)(Tooltip, {
    disabled: g,
    withinPortal: false,
    label: (0, import_jsx_runtime344.jsx)(G2, {
      mainTooltip: o,
      secondaryTooltip: s
    }),
    children: y
...
var pe = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, text: i, icon: a, isSelected: o, mainTooltip: s, secondaryTooltip: c, onClick: l, onMouseEnter: u, ...d } = e;
  Re(d, false);
  let [f, p] = (0, import_react441.useState)(false), m = (0, import_jsx_runtime344.jsxs)(Chip, {
    className: r2,
    checked: o === true,
    wrapperProps: {
      onMouseEnter: u,
      ...
      onClick: (e2) => {
        p(true), l == null ? void 0 : l(e2);
      }
    },
    variant: "light",
    icon: null,
    ref: t,
    children: [(0, import_jsx_runtime344.jsx)("span", { children: a }), (0, import_jsx_runtime344.jsx)("span", { children: i })]
  });
  return !s || f ? m : (0, import_jsx_runtime344.jsx)(Tooltip, {
    refProp: "rootRef",
    withinPortal: false,
    label: (0, import_jsx_runtime344.jsx)(G2, {
      mainTooltip: s,
...
var me = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, ...a } = e;
  return Re(a), (0, import_jsx_runtime344.jsx)(Group, {
    className: r2,
    ref: t,
    children: i
  });
});
var he = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: a, headerText: o, selected: s, onFocus: c, onBlur: l, tabIndex: u, ...d } = e;
  return Re(d, false), (0, import_jsx_runtime344.jsxs)(Card, {
    className: D(r2, s ? "selected" : ""),
    onFocus: c,
    onBlur: l,
    tabIndex: u,
    ref: t,
    children: [o && (0, import_jsx_runtime344.jsx)(Text, {
      className: "bn-header-text",
      children: o
    }), a]
  });
});
var ge = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, ...a } = e;
  return Re(a, false), (0, import_jsx_runtime344.jsx)(Card.Section, {
    className: r2,
    ref: t,
    children: i
  });
});
var _e = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, ...a } = e;
  return Re(a, false), (0, import_jsx_runtime344.jsx)(Divider, {
    className: r2,
    label: (0, import_jsx_runtime344.jsx)(Text, { children: i }),
    ref: t
  });
});
var ve = (0, import_react441.forwardRef)((e, t) => {
  let { authorInfo: r2, timeString: i, edited: a, ...o } = e, s = B();
  return Re(o, false), r2 === "loading" ? (0, import_jsx_runtime344.jsxs)(Group, { children: [(0, import_jsx_runtime344.jsx)(Skeleton, {
    height: 24,
    width: 24
  }), (0, import_jsx_runtime344.jsx)("div", { children: (0, import_jsx_runtime344.jsx)(Skeleton, {
    height: 12,
    width: 100
  }) })] }) : (0, import_jsx_runtime344.jsxs)(Group, { children: [(0, import_jsx_runtime344.jsx)(Avatar, {
    src: r2.avatarUrl,
    alt: r2.username,
    radius: "xl",
    size: "sm",
    color: "initials"
  }), (0, import_jsx_runtime344.jsxs)(Text, {
    fz: "sm",
    fw: "bold",
    children: [r2.username, (0, import_jsx_runtime344.jsxs)(Text, {
      fz: "xs",
      c: "dimmed",
      span: true,
      ml: "xs",
...
var ye = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, showActions: i, authorInfo: a, timeString: o, edited: s, actions: c, emojiPickerOpen: l, children: u, ...f } = e, { hovered: p, ref: m } = useHover2(), h = Vi([t, m]);
  return Re(f, false), (0, import_jsx_runtime344.jsxs)(Group, {
    pos: "relative",
    ref: h,
    className: r2,
    children: [
      c && (i === true || i === void 0 || i === "hover" && p || l) ? (0, import_jsx_runtime344.jsx)(Group, {
        style: {
          position: "absolute",
          right: 0,
          top: 0,
      ...
      (0, import_jsx_runtime344.jsx)(ve, { ...e }),
      u
    ]
  });
});
var be = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, autoFocus: i, onFocus: a, onBlur: o, editor: s, editable: l, ...u } = e;
  Re(u, false);
  let d = j();
  return (0, import_jsx_runtime344.jsx)(Z, {
    autoFocus: i,
    className: r2,
    editor: e.editor,
    sideMenu: false,
    ...
    onFocus: a,
    onBlur: o,
    children: (0, import_jsx_runtime344.jsx)(Vn, { formattingToolbar: xe })
  });
});
var xe = () => (0, import_jsx_runtime344.jsx)(zn, {
  blockTypeSelectItems: [],
  children: Rn([]).filter((e) => e.key !== "nestBlockButton" && e.key !== "unnestBlockButton")
});
var Se = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, name: a, label: o, variant: s, icon: c, value: l, autoFocus: u, placeholder: d, disabled: f, onKeyDown: p, onChange: m, onSubmit: h, autoComplete: g, "aria-activedescendant": _, rightSection: v, ...y } = e;
  return Re(y), (0, import_jsx_runtime344.jsx)(TextInput, {
    size: "xs",
    className: D(r2 || "", s === "large" ? "bn-mt-input-large" : ""),
    ref: t,
    name: a,
    label: o,
    leftSection: c,
...
var Ce = (0, import_react441.createContext)(void 0);
var we = (e) => {
  let { children: t, onOpenChange: r2, position: i, sub: a, ...o } = e;
  return Re(o), a ? (0, import_jsx_runtime344.jsx)(Menu.Sub, {
    transitionProps: {
      duration: 250,
      exitDelay: 250
    },
    ...
    position: i,
    children: t
  }) : (0, import_jsx_runtime344.jsx)(Menu, {
    withinPortal: false,
    middlewares: {
      flip: true,
      shift: true,
...
var Te = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, icon: a, checked: o, subTrigger: s, onClick: c, ...l } = e;
  return Re(l, false), (0, import_jsx_runtime344.jsx)(s ? Menu.Sub.Item : Menu.Item, {
    className: r2,
    ref: t,
    leftSection: a,
    rightSection: o ? (0, import_jsx_runtime344.jsx)(CheckIcon, { size: 10 }) : o === false ? (0, import_jsx_runtime344.jsx)("div", { className: "bn-tick-space" }) : null,
    onClick: c,
    ...l,
    children: i
  });
...
var Ee = (e) => {
  let { children: t, sub: r2, ...i } = e;
  return Re(i), (0, import_jsx_runtime344.jsx)(r2 ? Menu.Sub.Target : Menu.Target, { children: t });
};
var De = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, sub: a, ...o } = e;
  Re(o);
  let s = (0, import_react441.useContext)(Ce);
  return (0, import_jsx_runtime344.jsx)(a ? Menu.Sub.Dropdown : Menu.Dropdown, {
    className: r2,
    ref: t,
...
var Oe = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, ...i } = e;
  return Re(i), (0, import_jsx_runtime344.jsx)(Menu.Divider, {
    className: r2,
    ref: t
  });
});
var ke = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, ...a } = e;
  return Re(a), (0, import_jsx_runtime344.jsx)(Menu.Label, {
    className: r2,
    ref: t,
    children: i
  });
});
var Ae = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, icon: a, onClick: o, onDragEnd: s, onDragStart: c, draggable: l, label: u, ...d } = e;
  return Re(d, false), a ? (0, import_jsx_runtime344.jsx)(ActionIcon, {
    size: 24,
    className: r2,
    ref: t,
    onClick: o,
    ...
    ...d,
    children: a
  }) : (0, import_jsx_runtime344.jsx)(Button, {
    className: r2,
    ref: t,
    onClick: o,
    onDragEnd: s,
...
var je = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, tabs: i, defaultOpenTab: a, openTab: o, setOpenTab: s, loading: c, ...l } = e;
  return Re(l), (0, import_jsx_runtime344.jsx)(Group, {
    className: r2,
    ref: t,
    children: (0, import_jsx_runtime344.jsxs)(Tabs, {
      value: o,
      defaultValue: a,
      onChange: s,
      children: [
        c && (0, import_jsx_runtime344.jsx)(LoadingOverlay, { visible: c }),
        (0, import_jsx_runtime344.jsx)(Tabs.List, { children: i.map((e2) => (0, import_jsx_runtime344.jsx)(Tabs.Tab, {
          "data-test": `${e2.name.toLowerCase()}-tab`,
          value: e2.name,
          children: e2.name
        }, e2.name)) }),
        i.map((e2) => (0, import_jsx_runtime344.jsx)(Tabs.Panel, {
          value: e2.name,
...
var Me = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, onClick: a, label: o, ...s } = e;
  return Re(s), (0, import_jsx_runtime344.jsx)(Button, {
    size: "xs",
    "aria-label": o,
    className: r2,
    ref: t,
...
var Ne = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, accept: i, value: a, placeholder: o, onChange: s, ...c } = e;
  return Re(c), (0, import_jsx_runtime344.jsx)(FileInput, {
    size: "xs",
    className: r2,
    ref: t,
    accept: i,
...
var Pe = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, ...a } = e;
  return Re(a), (0, import_jsx_runtime344.jsx)("div", {
    className: r2,
    ref: t,
    children: i
  });
});
var Fe = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, value: i, placeholder: a, onKeyDown: o, onChange: s, ...c } = e;
  return Re(c), (0, import_jsx_runtime344.jsx)(TextInput, {
    size: "xs",
...
var Ie = (e) => {
  let { open: t, onOpenChange: r2, position: i, portalRoot: a, children: o, ...s } = e;
  return Re(s), (0, import_jsx_runtime344.jsx)(Popover, {
...
var Le = (e) => {
  let { children: t, ...r2 } = e;
  return Re(r2), (0, import_jsx_runtime344.jsx)(PopoverTarget, { children: t });
};
var Re2 = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, variant: a, ...o } = e;
  return Re(o), (0, import_jsx_runtime344.jsx)(PopoverDropdown, {
    className: r2,
    ref: t,
    children: i
  });
});
var ze = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, ...a } = e;
  return Re(a, false), (0, import_jsx_runtime344.jsx)(Group, {
    align: "center",
    gap: 0,
    className: r2,
    ref: t,
...
var Be2 = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, icon: a, onClick: o, onDragEnd: s, onDragStart: c, draggable: l, label: u, ...d } = e;
  return Re(d, false), a ? (0, import_jsx_runtime344.jsx)(ActionIcon, {
    size: 24,
    className: r2,
...
var Ve = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, id: a, ...o } = e;
  return Re(o), (0, import_jsx_runtime344.jsx)(Stack, {
    gap: 0,
    className: r2,
    ref: t,
    id: a,
...
var He = (0, import_react441.forwardRef)((e, t) => {
  ...
  return Re(a), (0, import_jsx_runtime344.jsx)(Group, {
    className: r2,
    ref: t,
    children: (0, import_jsx_runtime344.jsx)(Group, {
      className: "bn-mt-suggestion-menu-item-title",
      children: i
    })
  });
});
var Ue = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, isSelected: i, onClick: a, item: o, id: s, ...c } = e;
  Re(c);
  let u = (0, import_react441.useRef)(null);
  return (0, import_react441.useEffect)(() => {
  ...
  }, [i]), (0, import_jsx_runtime344.jsxs)(Group, {
    gap: 0,
    className: r2,
    ref: mergeRefs2(t, u),
    id: s,
    ...
    children: [
      o.icon && (0, import_jsx_runtime344.jsx)(Group, {
        className: "bn-mt-suggestion-menu-item-section",
        "data-position": "left",
        children: o.icon
      }),
      (0, import_jsx_runtime344.jsxs)(Stack, {
        gap: 0,
        className: "bn-mt-suggestion-menu-item-body",
        children: [(0, import_jsx_runtime344.jsx)(Text, {
          className: "bn-mt-suggestion-menu-item-title",
          children: o.title
        }), (0, import_jsx_runtime344.jsx)(Text, {
          className: "bn-mt-suggestion-menu-item-subtitle",
          children: o.subtext
        })]
      }),
      o.badge && (0, import_jsx_runtime344.jsx)(Group, {
        "data-position": "right",
        className: "bn-mt-suggestion-menu-item-section",
        children: (0, import_jsx_runtime344.jsx)(Badge, {
          size: "xs",
          children: o.badge
        })
      })
...
var We = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, ...a } = e;
  return Re(a), (0, import_jsx_runtime344.jsx)(Group, {
    className: r2,
    ref: t,
...
var Ge = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, ...i } = e;
  return Re(i), (0, import_jsx_runtime344.jsx)("div", {
    ref: t,
    children: (0, import_jsx_runtime344.jsx)(Loader, {
      className: r2,
      type: "dots",
      size: 16
    })
...
var Ke = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, id: a, columns: o, ...s } = e;
  return Re(s), (0, import_jsx_runtime344.jsx)("div", {
    className: r2,
...
var qe = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, columns: a, ...o } = e;
  return Re(o), (0, import_jsx_runtime344.jsx)(Group, {
    className: r2,
...
var Je = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, columns: a, ...o } = e;
  return Re(o), (0, import_jsx_runtime344.jsx)("div", {
    style: { gridColumn: `1 / ${a + 1}` },
    ref: t,
    children: (0, import_jsx_runtime344.jsx)(Loader, {
      className: r2,
...
var Ye = (0, import_react441.forwardRef)((e, t) => {
  let { children: r2, className: i, onMouseDown: a, onClick: o, ...s } = e;
  return Re(s, false), (0, import_jsx_runtime344.jsx)(Button, {
    className: i,
    ref: t,
    onMouseDown: a,
    onClick: o,
...
var Xe = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, draggable: a, onDragStart: o, onDragEnd: s, style: c, label: l, ...u } = e;
  return Re(u, false), (0, import_jsx_runtime344.jsx)(Button, {
    className: r2,
    ref: t,
    "aria-label": l,
    draggable: a,
...
var J = (0, import_react441.forwardRef)((e, t) => {
  let { className: r2, children: i, onMouseEnter: a, onMouseLeave: o, variant: s, ...c } = e;
  Re(c);
  let { ref: l, focused: u } = useFocusWithin();
  return (0, import_jsx_runtime344.jsx)(Flex, {
    className: r2,
    ref: mergeRefs2(t, l, useFocusTrap(u)),
    role: "toolbar",
    onMouseEnter: a,
    onMouseLeave: o,
...
var Y = (0, import_react441.forwardRef)((e, t) => {
  let { className: i, items: a, isDisabled: o, ...s } = e;
  Re(s);
  let c = a.filter((e2) => e2.isSelected)[0];
  return c ? (0, import_jsx_runtime344.jsxs)(Menu, {
    withinPortal: false,
    ...
    children: [(0, import_jsx_runtime344.jsx)(Menu.Target, { children: (0, import_jsx_runtime344.jsx)(Button, {
      onMouseDown: (e2) => {
        Be() && e2.currentTarget.focus();
      },
      leftSection: c.icon,
      rightSection: (0, import_jsx_runtime344.jsx)(HiChevronDown, {}),
      size: "xs",
      variant: "subtle",
      disabled: o,
      children: c.text
    }) }), (0, import_jsx_runtime344.jsx)(Menu.Dropdown, {
      className: i,
      ref: t,
      children: a.map((e2) => (0, import_jsx_runtime344.jsx)(Menu.Item, {
        onClick: e2.onClick,
        leftSection: e2.icon,
        rightSection: e2.isSelected ? (0, import_jsx_runtime344.jsx)(CheckIcon, {
          size: 10,
...
var Z = (e) => {
  let { className: t, theme: n, editor: r2, ...s } = e, c = j(), l = Ir(), u = (c == null ? void 0 : c.colorSchemePreference) || l, d = typeof n == "string" ? n : u === "no-preference" ? "light" : u, p = (0, import_react441.useCallback)((e2) => {
  ...
  (0, import_react441.useEffect)(() => {
    if (!r2.portalElement) throw Error("Portal element not found");
    r2.portalElement.setAttribute("data-mantine-color-scheme", d), p(r2.portalElement);
  }, [
    r2,
    p,
    d
  ]);
  let h = (0, import_react441.useContext)(MantineContext), g = (0, import_jsx_runtime344.jsx)(R.Provider, {
    value: X,
    children: (0, import_jsx_runtime344.jsx)(Gr, {
  ...
  return h ? g : (0, import_jsx_runtime344.jsx)(MantineProvider, {
