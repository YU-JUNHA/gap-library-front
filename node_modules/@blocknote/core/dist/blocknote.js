...
import { HardBreak as Ko } from "@tiptap/extension-hard-break";
...
function bi(e, t = JSON.stringify) {
  const o = {};
  return e.filter((i) => {
    const n = t(i);
...
function nt(e, t, o, i) {
  ...
  for (const [a, s] of Object.entries(e.styles)) {
    ...
    if (l.propSchema === "boolean")
      ...
      n.push(t.mark(a, { stringValue: s }));
    else
      throw new D(l.propSchema);
  }
  return !i || !t.nodes[i].spec.code ? e.text.split(/(\n)/g).filter((a) => a.length > 0).map((a) => a === `
` ? t.nodes.hardBreak.createChecked() : t.text(a, n)) : [t.text(e.text, n)];
}
function _i(e, t, o) {
...
function wi(e, t, o, i, n) {
  ...
  return o.serializeFragment(j.from(r), n);
}
function xi(e, t, o, i, n) {
  var u, h, m, f, g;
...
const Ei = () => typeof navigator < "u" && (/Mac/.test(navigator.platform) || /AppleWebKit/.test(navigator.userAgent) && /Mobile\/\w+/.test(navigator.userAgent));
function V(e, t = "Ctrl") {
  return Ei() ? e.replace("Mod", "⌘") : e.replace("Mod", t);
}
function G(...e) {
  return e.filter((t) => t).join(" ");
}
const ss = () => /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
function R(e, t, o, i) {
...
function me(e, t) {
  const o = $({
    ...
    addNodeView() {
      return ({ getPos: i }) => {
        var d;
        const n = this.options.editor, r = Si(
          i,
          n,
          this.editor,
          e.type
        ), a = ((d = this.options.domAttributes) == null ? void 0 : d.blockContent) || {}, s = t.render(r, n), l = be(
          s,
          r.type,
          r.props,
          e.propSchema,
        ...
        return e.isSelectable === !1 && Bi(l, this.editor), l;
      };
    }
  });
  if (o.name !== e.type)
...
function Kn(e, t) {
  return e in t.schema.inlineContentSchema && t.schema.inlineContentSchema[e] === Wn[e];
}
function qn(e, t, o) {
...
function T(e, t) {
  ...
  let i;
  return Array.isArray(o.content) && (o.content.length === 1 && de(o.content[0]) && o.content[0].type === "text" && o.content[0].text === "/" || o.content.length === 0) ? (i = e.updateBlock(o, t), e.setTextCursorPosition(i)) : (i = e.insertBlocks([t], o, "after")[0], e.setTextCursorPosition(e.getTextCursorPosition().nextBlock)), Zn(e), i;
}
function ks(e) {
  const t = [];
...
function ir(e, t) {
  return function({ state: o, dispatch: i }) {
    ...
    if (d.type !== e)
      return !1;
    if (i) {
      const c = d.lastChild && d.lastChild.type === t, u = j.from(c ? e.create() : null), h = new q(
        j.from(
...
function hr(e, t, o, i = { updateSelection: !0 }) {
...
function fr(e, t, o) {
  ...
  let h, m;
  if (c.content === "table") {
    const f = ot.get(l.blockContent.node);
    h = l.blockContent.beforePos + f.positionAt(0, 0, l.blockContent.node) + 1 + 2;
  } else
    h = l.blockContent.beforePos + 1;
  if (u.content === "table") {
    const f = ot.get(d.blockContent.node), g = d.blockContent.beforePos + f.positionAt(
      f.height - 1,
      f.width - 1,
      d.blockContent.node
...
function Xe(e) {
  ...
  return t.unified.unified().use(t.rehypeParse.default, { fragment: !0 }).use(br).use(kr).use(t.rehypeRemark.default).use(t.remarkGfm.default).use(t.remarkStringify.default, {
    handlers: { text: (i) => i.value }
  }).processSync(e).value;
}
async function _r(e, t, o, i) {
  await qe();
...
function wr(e) {
  e.querySelectorAll("li > ul, li > ol").forEach((t) => {
    const o = yr(t), i = t.parentElement, n = Array.from(i.childNodes).slice(
      o + 1
    );
  ...
  for (let s = 0; s < n.length; s++) {
    ...
    for (const c of r)
      for (const u of c.fileBlockAccept || []) {
        ...
        if (m && (!h && m.type && Tr(n[s].type, u) || h && Br(
          "." + m.name.split(".").pop(),
          u
        ))) {
          l = c.type;
    ...
    return {
      Backspace: () => this.editor.commands.first(({ chain: i, commands: n }) => [
        ...
        () => n.command(({ state: r }) => {
          ...
          const s = r.selection.from === a.blockContent.beforePos + 1, l = r.selection.empty, d = Ve(
            r.doc,
            a.bnBlock.beforePos
          );
          if (d && s && l) {
      ...
      state: {
        ...
        apply(o, i, n, r) {
          if (i.currentTransactionOldBlockAttrs = {}, i.updatedBlocks.clear(), !o.docChanged || n.doc.eq(r.doc))
            return i;
          const a = {}, s = et(n.doc, (c) => c.attrs.id), l = new Map(
            s.map((c) => [c.node.attrs.id, c])
          ), d = et(r.doc, (c) => c.attrs.id);
          for (const c of d) {
  ...
  constructor(t, o, i) {
    ...
    p(this, "mouseMoveHandler", (t) => {
      ...
      if ((o == null ? void 0 : o.type) === "wrapper") {
        ...
        const m = ke(o.domNode), f = ke(o.domNode.parentElement), g = o.domNode.getBoundingClientRect();
...
function Sa(e, t) {
  ...
  if (o = Ea(o, t.state.schema), !Ba(o, t))
  ...
  for (let i = 0; i < o.childCount; i++)
    if (o.child(i).type.spec.group === "blockContent") {
      ...
      if (i + 1 < o.childCount && o.child(i + 1).type.name === "blockGroup") {
        ...
        (a.type.name === "bulletListItem" || a.type.name === "numberedListItem" || a.type.name === "checkListItem") && (n.push(o.child(i + 1)), o = Ca(o, i + 1));
      }
...
class mo {
  constructor(t) {
    ...
    if (this.schema = i.schema, this.blockImplementations = i.schema.blockSpecs, this.inlineContentImplementations = i.schema.inlineContentSpecs, this.styleImplementations = i.schema.styleSpecs, this.extensions = wa({
      editor: this,
  ...
  async blocksToFullHTML(t) {
    return Ci(this.pmSchema, this).serializeBlocks(t, {});
  }
  /**
  ...
  async blocksToMarkdownLossy(t = this.document) {
    return _r(t, this.pmSchema, this, {});
  }
  /**
...
function Ma(e) {
  e.id || (e.id = ue.options.generateID()), e.children && Ia(e.children);
}
function Ia(e) {
  for (const t of e)
    Ma(t);
...
export {
  ...
  Mi as addInlineContentKeyboardShortcuts,
  Ni as addStyleAttributes,
  Bi as applyNonSelectableBlockFix,
  as as assertEmpty,
  ...
  ms as checkBlockIsFileBlock,
  gs as checkBlockIsFileBlockWithPlaceholder,
  fs as checkBlockIsFileBlockWithPreview,
  Xn as checkBlockTypeHasDefaultProp,
  I as checkDefaultBlockTypeInSchema,
  Kn as checkDefaultInlineContentTypeInSchema,
  Jn as checkPageBreakBlocksInSchema,
  ...
  ws as uploadToTmpFilesDotOrg_DEV_ONLY,
  Rn as videoBlockConfig,
  zn as videoParse,
  On as videoPropSchema,
  Vn as videoRender,
  Fn as videoToExternalHTML,
  ys as withPageBreak,
