...
import { useFloating as se, useTransitionStyles as de, useDismiss as pt, useInteractions as kt, offset as O, flip as A, shift as Fe, size as ue, FloatingPortal as vt } from "@floating-ui/react";
import { filenameFromURL as ve, formatKeyboardShortcut as Q, VALID_LINK_PROTOCOLS as wt, DEFAULT_LINK_PROTOCOL as Ht, checkBlockIsFileBlock as U, checkBlockIsFileBlockWithPlaceholder as z, checkBlockIsFileBlockWithPreview as Mt, checkBlockHasDefaultProp as le, checkBlockTypeHasDefaultProp as D, getDefaultEmojiPickerItems as yt, getDefaultSlashMenuItems as Vt, filterSuggestionItems as Lt, mergeCSSClasses as ee, EMPTY_CELL_WIDTH as xt, EMPTY_CELL_HEIGHT as St, inheritedProps as Bt, camelToDataKebab as De, createStronglyTypedTiptapNode as Ae, propsToAttributes as Ue, getParseRules as Tt, wrapInBlockStructure as _t, getBlockFromPos as Et, applyNonSelectableBlockFix as Rt, createInternalBlockSpec as Pt, audioParse as Nt, audioBlockConfig as It, fileParse as Ot, fileBlockConfig as Zt, imageParse as Ft, imageBlockConfig as Dt, getPageBreakSlashMenuItems as At, videoParse as Ut, videoBlockConfig as zt, BlockNoteEditor as Gt, addInlineContentKeyboardShortcuts as Wt, getInlineContentParseRules as jt, nodeToCustomInlineContent as we, addInlineContentAttributes as $t, inlineContentToNodes as qt, createInternalInlineContentSpec as Kt, stylePropsToAttributes as Xt, getStyleParseRules as Yt, addStyleAttributes as Jt, createInternalStyleSpec as Qt } from "@blocknote/core";
import en, { createPortal as ge, flushSync as ze } from "react-dom";
import { NodeViewWrapper as Ge, ReactNodeViewRenderer as We, useReactNodeView as je, Mark as tn } from "@tiptap/react";
const $e = Oe(void 0);
function E(e) {
  return Ze($e);
}
...
function Z(e, t, n, o) {
  const { refs: r, update: i, context: c, floatingStyles: s } = se({
    open: e,
    ...o
  }), { isMounted: d, styles: a } = de(c), u = pt(c), { getReferenceProps: g, getFloatingProps: m } = kt([u]);
  return y(() => {
    i();
  }, [t, i]), y(() => {
...
const on = (e) => {
  const t = p(), n = L(), { block: o } = e, r = v(), [i, c] = f(""), s = k(
    (u) => {
  ...
  var g;
  const t = p(), n = L(), { block: o, setLoading: r } = e, i = v(), [c, s] = f(!1);
  y(() => {
    c && setTimeout(() => {
      s(!1);
    }, 3e3);
  ...
  const t = p(), n = L(), o = v(), [r, i] = f(!1), c = e.tabs ?? [
    ...o.uploadFile !== void 0 ? [
      {
        name: n.file_panel.upload.title,
        tabPanel: /* @__PURE__ */ l(rn, { block: e.block, setLoading: i })
      }
    ] : [],
    {
      name: n.file_panel.embed.title,
      tabPanel: /* @__PURE__ */ l(on, { block: e.block })
    }
  ], [s, d] = f(
...
var Ke = {
  ...
  style: void 0,
  attr: void 0
}, He = R.createContext && /* @__PURE__ */ R.createContext(Ke), an = ["attr", "size", "title"];
function sn(e, t) {
  if (e == null) return {};
  var n = dn(e, t), o, r;
...
function C(e) {
  return (t) => /* @__PURE__ */ R.createElement(hn, X({
    attr: Y({}, e.attr)
  }, t), Xe(e.child));
}
function hn(e) {
...
const Dn = () => {
  const e = p(), t = L(), n = v(), o = xe("text", n), r = xe("background", n), i = T(n), [c, s] = f(
  ...
  const t = p(), n = L(), { url: o, text: r, editLink: i } = e, [c, s] = f(o), [d, a] = f(r);
  y(() => {
    s(o), a(r);
  }, [r, o]);
  const u = k(
...
const Un = () => {
  var h;
  const e = v(), t = p(), n = L(), o = An(e), r = T(e), [i, c] = f(!1), [s, d] = f(e.getSelectedLinkUrl() || ""), [a, u] = f(e.getSelectedText());
  N(() => {
  ...
  const e = L(), t = p(), n = v(), [o, r] = f(), i = T(n), c = H(() => {
    if (i.length !== 1)
      return;
    const a = i[0];
    if (U(a, n))
  ...
  const e = L(), t = p(), n = v(), o = T(n), [r, i] = f(!1);
  y(() => {
    i(!1);
  }, [o]);
  ...
  const t = p(), n = L(), o = v(), r = T(o), [i, c] = f(o.getTextCursorPosition().block), s = H(() => (e.items || Kn(n)).filter(
...
const Yn = () => {
  ...
  /* @__PURE__ */ l(Xn, { items: e }, "blockTypeSelect"),
  /* @__PURE__ */ l(zn, {}, "fileCaptionButton"),
  /* @__PURE__ */ l(jn, {}, "replaceFileButton"),
  /* @__PURE__ */ l(Wn, {}, "fileRenameButton"),
  /* @__PURE__ */ l(Gn, {}, "fileDeleteButton"),
  /* @__PURE__ */ l(Yn, {}, "fileDownloadButton"),
  /* @__PURE__ */ l(Jn, {}, "filePreviewButton"),
  ...
  /* @__PURE__ */ l(Dn, {}, "colorStyleButton"),
  /* @__PURE__ */ l($n, {}, "nestBlockButton"),
  /* @__PURE__ */ l(qn, {}, "unnestBlockButton"),
  /* @__PURE__ */ l(Un, {}, "createLinkButton")
], at = (e) => {
  const t = p();
  return /* @__PURE__ */ l(
    t.FormattingToolbar.Root,
    {
      ...
      children: e.children || eo(e.blockTypeSelectItems)
    }
  );
}, Be = (e) => {
  switch (e) {
  ...
  return e.children ? /* @__PURE__ */ l(t.LinkToolbar.Root, { className: "bn-toolbar bn-link-toolbar", children: e.children }) : /* @__PURE__ */ M(
    t.LinkToolbar.Root,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ l(ro, { url: e.url }),
        /* @__PURE__ */ l(no, { deleteLink: e.deleteLink })
      ]
    }
  );
}, io = (e) => {
  ...
  if (!r || !o)
    return null;
  const { show: d, referencePos: a, ...u } = o, g = e.linkToolbar || lo;
...
const ao = (e) => {
  ...
  return /* @__PURE__ */ l(
    t.SideMenu.Button,
    {
      ...
      icon: /* @__PURE__ */ l(co, { size: 24, onClick: r, "data-test": "dragHandleAdd" })
    }
  );
};
function st(e) {
...
const so = (e) => {
  ...
  return /* @__PURE__ */ l(
    t.Generic.Menu.Dropdown,
    {
      ...
      children: e.children || /* @__PURE__ */ M(B, { children: [
        /* @__PURE__ */ l(uo, { ...e, children: n.drag_handle.delete_menuitem }),
        /* @__PURE__ */ l(so, { ...e, children: n.drag_handle.colors_menuitem })
      ] })
    }
  );
}, mo = (e) => {
  const t = p(), n = L(), o = e.dragHandleMenu || go;
  return /* @__PURE__ */ M(
    t.Generic.Menu.Root,
    {
      onOpenChange: (r) => {
  ...
  if (!r || !o)
    return null;
  const { show: d, referencePos: a, ...u } = o, g = e.sideMenu || ho;
...
function Co(e) {
  const t = p(), n = L(), { items: o, loadingState: r, selectedIndex: i, onItemClick: c, columns: s } = e, d = r === "loading-initial" || r === "loading" ? /* @__PURE__ */ l(
...
function vo(e) {
  const t = v(), {
    ...
    [t.suggestionMenus, n]
  ), h = P(m), { isMounted: b, ref: V, style: w, getFloatingProps: x } = Z(
  ...
  return !b || !h || !(h != null && h.ignoreQueryLength) && i && (h.query.startsWith(" ") || h.query.length < i) ? null : /* @__PURE__ */ l("div", { ref: V, style: w, ...x(), children: /* @__PURE__ */ l(
    ko,
    {
      query: h.query,
      ...
      getItems: u,
      columns: r,
      gridSuggestionMenuComponent: o || Co,
      onItemClick: a
    }
  ) });
}
function wo(e) {
  const t = p(), n = L(), { items: o, loadingState: r, selectedIndex: i, onItemClick: c } = e, s = r === "loading-initial" || r === "loading" ? /* @__PURE__ */ l(t.SuggestionMenu.Loader, { className: "bn-suggestion-menu-loader", children: n.suggestion_menu.loading }) : null, d = H(() => {
    let a;
    const u = [];
    for (let g = 0; g < o.length; g++) {
      const m = o[g];
...
function Ho(e, t, n, o) {
  ...
  return y(() => {
    var s;
    const c = (d) => d.key === "ArrowUp" ? (d.preventDefault(), n.length && i((r - 1 + n.length) % n.length), !0) : d.key === "ArrowDown" ? (d.preventDefault(), n.length && i((r + 1) % n.length), !0) : d.key === "Enter" && !d.isComposing ? (d.preventDefault(), d.stopPropagation(), n.length && (o == null || o(n[r])), !0) : !1;
...
function Lo(e) {
  const t = v(), {
    ...
    [t.suggestionMenus, n]
  ), m = P(g), { isMounted: h, ref: b, style: V, getFloatingProps: w } = Z(
  ...
  return !h || !m || !(m != null && m.ignoreQueryLength) && r && (m.query.startsWith(" ") || m.query.length < r) ? null : /* @__PURE__ */ l("div", { ref: b, style: V, ...w(), children: /* @__PURE__ */ l(
    Mo,
    {
      query: m.query,
...
const So = (e, t = 0.3) => {
  ...
  return y(() => {
    ...
    t.TableHandle.ExtendButton,
    {
      ...
      onClick: c,
      onMouseDown: i,
      children: e.children || /* @__PURE__ */ l(Rn, { size: 18, "data-test": "extendButton" })
    }
  );
}, To = (e) => {
  const t = p(), n = L(), o = v();
...
}, Ee = (e) => e.orientation === "row" ? /* @__PURE__ */ l(To, { ...e, side: e.side }) : /* @__PURE__ */ l(_o, { ...e, side: e.side }), Eo = (e) => {
  const t = p(), n = L(), o = v();
  return /* @__PURE__ */ l(
    t.Generic.Menu.Item,
    {
...
}, Po = (e) => e.orientation === "row" ? /* @__PURE__ */ l(Eo, { ...e }) : /* @__PURE__ */ l(Ro, { ...e }), No = (e) => {
  const t = p();
  ...
  const t = p(), [n, o] = f(!1), r = e.tableHandleMenu || No;
  return /* @__PURE__ */ M(
    t.Generic.Menu.Root,
    {
      onOpenChange: (i) => {
...
function Pe(e, t, n, o, r) {
  ...
  return y(() => {
    ...
    n === null || o === null || i.setReference({
      getBoundingClientRect: () => (e === "row" ? Zo : Fo)(n, o, r)
    });
  }, [r, e, n, o, i]), H(
    () => ({
      isMounted: a,
...
const Ao = (e) => {
  ...
  if (!a)
    return null;
  const _ = e.tableHandle || Io, G = e.extendButton || Bo;
  return /* @__PURE__ */ M(B, { children: [
    /* @__PURE__ */ l("div", { ref: o }),
    /* @__PURE__ */ M(vt, { root: a.widgetContainer, children: [
      !V && n && g.isMounted && a.rowIndex !== void 0 && /* @__PURE__ */ l("div", { ref: g.ref, style: g.style, children: /* @__PURE__ */ l(
        _,
        {
          editor: t,
          orientation: "row",
...
function Uo(e) {
  ...
  return /* @__PURE__ */ M(B, { children: [
    e.formattingToolbar !== !1 && /* @__PURE__ */ l(to, {}),
    e.linkToolbar !== !1 && /* @__PURE__ */ l(io, {}),
    e.slashMenu !== !1 && /* @__PURE__ */ l(Lo, { triggerCharacter: "/" }),
    ...
    t.filePanel && e.filePanel !== !1 && /* @__PURE__ */ l(ln, {}),
    t.tableHandles && e.tableHandles !== !1 && /* @__PURE__ */ l(Ao, {})
  ] });
}
const zo = () => {
  const e = H(
...
function $o(e, t) {
  const {
    ...
    tableHandles: V,
    ...w
  } = e, [x, S] = f(), _ = E(), G = zo(), W = (_ == null ? void 0 : _.colorSchemePreference) || G, F = r || (W === "dark" ? "dark" : "light");
  ...
  return /* @__PURE__ */ M($e.Provider, { value: $, children: [
    /* @__PURE__ */ l(jo, { ref: ht }),
    !n.headless && /* @__PURE__ */ l(Wo, { editor: n, children: /* @__PURE__ */ M(
      "div",
      {
        className: ee(
          "bn-container",
...
const vr = R.forwardRef($o);
var ae, K = en;
if (process.env.NODE_ENV === "production")
  ae = K.createRoot, K.hydrateRoot;
else {
  var Ie = K.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
  ae = function(e, t) {
...
const ar = (e) => {
  ...
  mt,
  {
    ...
    buttonIcon: /* @__PURE__ */ l(En, { size: 24 }),
    children: /* @__PURE__ */ l(ar, { ...e })
  }
), Vr = te(zt, {
  render: dr,
  parse: Ut,
...
export {
  ao as AddBlockButton,
  Ee as AddButton,
  _o as AddColumnButton,
  Xo as AddFileButton,
  To as AddRowButton,
  er as AudioBlock,
  Jo as AudioPreview,
  ...
  so as BlockColorsItem,
  re as BlockContentWrapper,
  $e as BlockNoteContext,
  Uo as BlockNoteDefaultUI,
  vr as BlockNoteViewRaw,
  Xn as BlockTypeSelect,
  Dn as ColorStyleButton,
  nn as ComponentsContext,
  Un as CreateLinkButton,
  Po as DeleteButton,
  Ro as DeleteColumnButton,
  no as DeleteLinkButton,
  Eo as DeleteRowButton,
  mo as DragHandleButton,
  go as DragHandleMenu,
  oo as EditLinkButton,
  ct as EditLinkMenuItems,
  on as EmbedTab,
  Lr as ExperimentalMobileFormattingToolbarController,
  Bo as ExtendButton,
  pe as FigureWithCaption,
  nr as FileBlock,
  ke as FileBlockWrapper,
  zn as FileCaptionButton,
  Gn as FileDeleteButton,
  Yn as FileDownloadButton,
  Yo as FileNameWithIcon,
  qe as FilePanel,
  ln as FilePanelController,
  Jn as FilePreviewButton,
  Wn as FileRenameButton,
  jn as FileReplaceButton,
  tr as FileToExternalHTML,
  at as FormattingToolbar,
  to as FormattingToolbarController,
  vo as GridSuggestionMenuController,
  ko as GridSuggestionMenuWrapper,
  lr as ImageBlock,
  or as ImagePreview,
  rr as ImageToExternalHTML,
  mr as InlineContentWrapper,
  lo as LinkToolbar,
  io as LinkToolbarController,
  ne as LinkWithCaption,
  $n as NestBlockButton,
  ro as OpenLinkButton,
  wr as ReactAudioBlock,
  Hr as ReactFileBlock,
  Mr as ReactImageBlock,
  Vr as ReactVideoBlock,
  uo as RemoveBlockItem,
  mt as ResizableFileBlockWrapper,
  ho as SideMenu,
  fo as SideMenuController,
  Lo as SuggestionMenuController,
  Mo as SuggestionMenuWrapper,
  Io as TableHandle,
  No as TableHandleMenu,
  Ao as TableHandlesController,
  oe as TextAlignButton,
  qn as UnnestBlockButton,
  rn as UploadTab,
  dr as VideoBlock,
  ar as VideoPreview,
  sr as VideoToExternalHTML,
  Kn as blockTypeSelectItems,
  te as createReactBlockSpec,
  Tr as createReactInlineContentSpec,
  _r as createReactStyleSpec,
  Er as elementOverflow,
  bo as getDefaultReactEmojiPickerItems,
  Vo as getDefaultReactSlashMenuItems,
  eo as getFormattingToolbarItems,
  yr as getPageBreakReactSlashMenuItems,
  cn as mergeRefs,
  xr as useActiveStyles,
  Sr as useBlockNote,
  E as useBlockNoteContext,
  v as useBlockNoteEditor,
  dt as useCloseSuggestionMenuNoItems,
  p as useComponentsContext,
  ur as useCreateBlockNote,
  L as useDictionary,
  ...
  po as useGridSuggestionMenuKeyboardNavigation,
  ut as useLoadSuggestionMenuItems,
  zo as usePrefersColorScheme,
  Ce as useResolveUrl,
  T as useSelectedBlocks,
  Ho as useSuggestionMenuKeyboardNavigation,
  Do as useTableHandlesPositioning
};
